...
public class Player extends Rectangle {
	...
	public Player(float x, float y, Image image, GameContainer gc) throws SlickException {
		...
		Image walruswiz2 = new Image("res/pong/walruswiz2.png");
		...
		this.timeLostImage = new Image("res/pong/timeLostImg.png");

		killedBossSound = new Sound("res/pong/bossKilled.wav");

		try {
			this.fire = ParticleIO.loadConfiguredSystem("res/pong/bossSystem.xml");
		} catch (IOException e) {
	...
	public void addFireball() throws SlickException {
		...
		SpriteSheet fireSheet = new SpriteSheet("res/pong/fireball.png", 11, 20);
