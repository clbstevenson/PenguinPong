...
public class LostGameState extends BasicGameState implements ComponentListener {
	...
	public void init(GameContainer gc, StateBasedGame sbg)
		...
		this.rocket = new Image("res/pong/fireball.png").getScaledCopy(3.0F);
		this.ry = 500.0F;
		...
		SpriteSheet losticons = new SpriteSheet("res/pong/losticons.png", 60, 20);
		for (int j = 0; j < 2; j++) {
	...
	public void enter(GameContainer gc, StateBasedGame sbg)
		...
		this.rocket = new Image("res/pong/fireball.png").getScaledCopy(4.0F);
		this.ry = 500.0F;
		this.rx = ((float) (Math.random() * 400.0D + 100.0D));
