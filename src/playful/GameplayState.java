...
public class GameplayState extends BasicGameState {
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		this.font1 = new AngelCodeFont("res/font1.fnt", "res/font1_0.tga");
		this.smallFont1 = new AngelCodeFont("res/smallFont1.fnt", "res/smallFont1_0.tga");
		...
		boom.setFilter(2);
		this.penguin = new Image("res/penguin.png");
		this.penguin.setFilter(2);

		this.blip = new Sound("res/blip2.wav");
		this.bonusSound = new Sound("res/coinbonus.wav");
		this.fireballSound = new Sound("res/fireball.wav");
		this.nukeSound = new Sound("res/nuke.wav");
		this.cannonballSound = new Sound("res/cannonballSound2.wav");
		this.hitBossSound = new Sound("res/hitBoss.wav");
		fellSound = new Sound("res/penguinfell.wav");
		this.music1 = new Music("res/penguinmusic1.wav");

		this.mapPos = new Vector2f(0.0F, 0.0F);

		Image playerImage = new Image("res/iceblock.png");

		player = new Player(gc.getWidth() / 2 - 50, gc.getHeight() - 35, playerImage, gc);

		penguinLoader = new PenguinLoader("res/robotpenguin.png", 20, 20, "res/robotbosspenguin.png", player, ents, penguins, gc);
	}
	...
	public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
		...
		if (player.difficulty == 4 || player.cheats[1]) {
			g.scale(0.9f, 0.9f);
	...
	public static void makeNewBonus2(GameContainer gc) throws SlickException {
		Entity newEntity = null;
		Animation animation = new Animation();
		SpriteSheet sheet = new SpriteSheet("res/bonuses.png", 10, 10);
	...
	public static void shootFireball(Penguin p) throws SlickException {
		...
		Animation animation = new Animation();
		SpriteSheet fireSheet = new SpriteSheet("res/bowlingball.png", 40, 40);
